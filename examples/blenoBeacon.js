...
advertisementData[2] = 0xAA; // Eddystone Beacon ID
advertisementData[3] = 0xFE; // Eddystone Beacon ID
advertisementData[4] = 0x0A; // Length
advertisementData[5] = 0x16; // Service Data
advertisementData[6] = 0xAA; // Eddystone Beacon ID
advertisementData[7] = 0xFE; // Eddystone Beacon ID
advertisementData[8] = 0x10; // Flags
